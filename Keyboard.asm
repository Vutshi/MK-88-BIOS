   ...
   f000:eaff       MOV        word ptr [offset DAT_0000_0472]
   ...
   f000:eb76       MOV        byte ptr [offset DAT_0000_0471]
   f000:eb7b       INT        0x1b
   ...
   f000:eb9a       MOV        AL,[offset CRT_MODE_SET]         GET THE VALUE OF THE CURRENT MODE
   f000:eb9d       OUT        DX,AL                            SET THE CRT MODE, SO THAT CRT IS
